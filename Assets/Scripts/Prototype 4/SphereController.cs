...
public class SphereController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        sphereRB.AddForce(focalPoint.transform.forward * forwardInput * sphereSpeed * Time.deltaTime);
    ...
    IEnumerator Smash()
    {
        ...
        while (Time.time < jumpTime)
        {
            ...
            sphereRB.velocity = new Vector2(sphereRB.velocity.x, smashSpeed);
            yield return null;
        }
        //Now move the player down
        while (transform.position.y > floorY)
        {
            sphereRB.velocity = new Vector2(sphereRB.velocity.x, -smashSpeed * 2);
            yield return null;
        }
